...
namespace ProductClassLibrary.Tests
{
    public class ProductTest
    {
        ...
        public void AddOperatorLaptop_WhenOperandsAreValid_ShouldReturnCorrectResult1(string name1, decimal price1, int frequancy1,
                                                                                      string name2, decimal price2, int frequancy2)
        {
            // Arrange - Act
            ...
            Laptop expected = new Laptop
            {
                Name = name1 + "-" + name2,
                Price = (price1 + price2) / 2,
                CPUFrequancy = frequancy1 + frequancy2,
            };
